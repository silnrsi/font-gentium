...
<!-- Copied from Harmattan repo tools/ftml.xsl. 
     regtochar script updated from ftml repo FTMLcreateList.xsl to handle non-BMP chars .
     Each fontsrc elements in the ftml will be rendered in a column  -->
