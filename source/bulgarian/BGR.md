...
![Sample Image](/source/bulgarian/images/GentiumPlus_Cyrillic_Models.jpg)
...
### New lines in lookup sc1_sub for Bulgarian Cyrillic (Normal weights);
```
lookup sc1_sub {
    lookupflag 0;
    #sub @cno_sc by @c_sc;
	...
	#new classes (@cyrBGR to @cyrBGR_sc) for substitution from Bulgarian Cyrillic to small caps Cyrillic must be introduced in the section CLASSES;
	#@cyrBGR = [CySmVe.loclBGR CySmGhe.loclBGR CySmDe.loclBGR CySmZhe.loclBGR CySmZe.loclBGR CySmI.loclBGR CySmShortI.loclBGR CySmIGrave.loclBGR CySmKaSC.loclBGR CySmEl.loclBGR CySmEn.loclBGR CySmPe.loclBGR CySmTe.loclBGR CySmTse.loclBGR CySmChe.loclBGR CySmSha.loclBGR CySmShcha.loclBGR CySmHardSgn.loclBGR CySmSoftSgn.loclBGR CySmYu.loclBGR];
	#@cyrBGR_sc = [CySmVe.sc CySmGhe.sc CySmDeloclBGR.sc CySmZhe.sc CySmZe.sc CySmI.sc CySmShortI.sc CySmIGrave.sc CySmKaSC.sc CySmElloclBGR.sc CySmEn.sc CySmPe.sc CySmTe.sc CySmTse.sc CySmChe.sc CySmSha.sc CySmShcha.sc CySmHardSgn.sc CySmSoftSgn.sc CySmYu.sc];
	sub @cyrBGR by @cyrBGR_sc;
} sc1_sub;
```


### New lines in lookup sc1_sub for Bulgarian Cyrillic (Italic weights);
```
lookup sc1_sub {
    lookupflag 0;
    #sub @cno_sc by @c_sc;
    ...
    sub LtnSmTurnedE by LtnSmRevE.sc;
	#new classes (@cyrBGR to @cyrBGR_sc) for substitution from Bulgarian Cyrillic to small caps Cyrillic must be introduced in the section CLASSES;
	#@cyrBGR = [CySmVe.loclBGR CySmGhe.loclBGR CySmDe.loclBGR CySmZhe.loclBGR CySmZe.loclBGR CySmKa.loclBGR CySmEl.loclBGR CySmEn.loclBGR CySmYu.loclBGR];
	#@cyrBGR_sc = [CySmVe.sc CySmGhe.sc CySmDeloclBGR.sc CySmZhe.sc CySmZe.sc CySmKa.sc CySmElloclBGR.sc CySmEn.sc CySmYu.sc];
	sub @cyrBGR by @cyrBGR_sc;
} sc1_sub;
```


### New lines in lookup sc2_sub for Bulgarian Cyrillic (Normal weights);
```
lookup sc2_sub {
    lookupflag 0;
    sub @cno_c2sc by @c_c2sc;
    sub CyPalochka by CyPalochka.sc;
	#new classes (@cyrcapsBGR to @cyrcapsBGR_sc) for substitution from Bulgarian Cyrillic to small caps Cyrillic must be introduced in the section CLASSES;
	#@cyrcapsBGR = [CyCapDe CyCapI CyCapShortI CyCapIGrave CyCapEl];
	#@cyrcapsBGR_sc = [CyCapDe.loclBGR CyCapI.loclBGR CyCapShortI.loclBGR CyCapIGrave.loclBGR CyCapEl.loclBGR];
	sub @cyrcapsBGR by @cyrcapsBGR_sc;
} sc2_sub;
```


### New lines in lookup sc2_sub for Bulgarian Cyrillic (Italic weights);
```
lookup sc2_sub {
    lookupflag 0;
    sub @cno_c2sc by @c_c2sc;
